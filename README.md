...
- [ ] Dégâts du vent (arbres qui plient/tombent/repoussent, maisons qui se fissurent/perdent leur toit/s'effondrent, débris) et fumée des cheminées
- [ ] Son du tonnerre (synthétisé, comme l'original) sur les éclairs
...
- [ ] Curseur personnalisé selon le survol (optionnel, détail desktop mineur)
